...
function Projects(){
    const e1 = "Fernando Chavez created and designed the landing page and the explore your cabinet page." 
    const e2 = "Fernando Chavez made the entire back end, including login, register, adding a new recipe, viewing recipes, and a LOT more."
    const e3 = "Fernando Chavez created all the connectivity from the front end to the back end, all sign in pages and all API calls, I also helped with the front end design."

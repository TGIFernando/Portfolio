...
function Projects(){
    ...
    const e4 = "Fernando Chavez created everything on this app(except the api). The app makes an api call to find the lyrics and I made a loading indicator and other special case indicators."
